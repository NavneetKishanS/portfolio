const project6 = {
  ...
  description: [
    "D* Built an end-to-end path planning pipeline using GraphSAGE-based GNNs to learn node-level path saliency from randomized grid environments and A* reference solutions.",
